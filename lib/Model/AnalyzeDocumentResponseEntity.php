...
/**
 * AnalyzeDocumentResponseEntity Class Doc Comment
 *
 * @category Class
 * @package  Dojah
 * @implements \ArrayAccess<string, mixed>
 */
class AnalyzeDocumentResponseEntity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AnalyzeDocumentResponse_entity';
    ...
    */
     ...
     * Gets document_type
     *
     * @return \Dojah\Model\AnalyzeDocumentResponseEntityDocumentType|null
     */
     ...
     * Sets document_type
     *
     * @param \Dojah\Model\AnalyzeDocumentResponseEntityDocumentType|null $document_type document_type
     *
     * @return self
     */
     ...
     * Gets text_data
     *
     * @return \Dojah\Model\AnalyzeDocumentResponseEntityTextDataInner[]|null
     */
     ...
     * Sets text_data
     *
     * @param \Dojah\Model\AnalyzeDocumentResponseEntityTextDataInner[]|null $text_data text_data
     *
     * @return self
     */
    public function setTextData($text_data)
    {
        ...
        if (is_null($text_data)) {
            throw new \InvalidArgumentException('non-nullable text_data cannot be null');
        }
