...
/**
 * FraudScreenUserResponseEntityEmailCheckResultDomainDetails Class Doc Comment
 *
 * @category Class
 * @package  Dojah
 * @implements \ArrayAccess<string, mixed>
 */
class FraudScreenUserResponseEntityEmailCheckResultDomainDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FraudScreenUserResponse_entity_email_check_result_domain_details';
    ...
    */
    ...
    public function setRegisteredTo($registered_to)
    {
        ...
        if (is_null($registered_to)) {
            throw new \InvalidArgumentException('non-nullable registered_to cannot be null');
        }
