...
/**
 * GetPassportResponseEntity Class Doc Comment
 *
 * @category Class
 * @package  Dojah
 * @implements \ArrayAccess<string, mixed>
 */
class GetPassportResponseEntity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetPassportResponse_entity';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('place_of_issue', $data ?? [], null);
    ...
    */
     ...
     * Sets place_of_issue
     *
     * @param string|null $place_of_issue place_of_issue
     *
     * @return self
     */
    public function setPlaceOfIssue($place_of_issue)
    {
        ...
        if (is_null($place_of_issue)) {
            throw new \InvalidArgumentException('non-nullable place_of_issue cannot be null');
        }
