...
/**
 * GetWalletsResponseEntityClientWalletsInner Class Doc Comment
 *
 * @category Class
 * @package  Dojah
 * @implements \ArrayAccess<string, mixed>
 */
class GetWalletsResponseEntityClientWalletsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetWalletsResponse_entity_client_wallets_inner';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('wallet_amount', $data ?? [], null);
