...
/**
 * GetSsnitResponseEntity Class Doc Comment
 *
 * @category Class
 * @package  Dojah
 * @implements \ArrayAccess<string, mixed>
 */
class GetSsnitResponseEntity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetSsnitResponse_entity';
    ...
    {
        $this->setIfExists('card_serial', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['card_serial'];
    }

    /**
     * Sets card_serial
     *
     * @param string|null $card_serial card_serial
     *
     * @return self
     */
    public function setCardSerial($card_serial)
    {

        if (is_null($card_serial)) {
            throw new \InvalidArgumentException('non-nullable card_serial cannot be null');
        }

        $this->container['card_serial'] = $card_serial;
